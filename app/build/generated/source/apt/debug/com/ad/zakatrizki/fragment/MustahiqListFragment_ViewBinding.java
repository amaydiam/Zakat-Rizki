...
public class MustahiqListFragment_ViewBinding<T extends MustahiqListFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public MustahiqListFragment_ViewBinding(final T target, View source) {
    this.target = target;
    ...
    view = Utils.findRequiredView(source, R.id.fab_action, "field 'fabAction' and method 'AddMustahiq'");
