...
public class MustahiqAdapter$ViewHolder_ViewBinding<T extends MustahiqAdapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public MustahiqAdapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
